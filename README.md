...
A Clinical Decision Support System for 30-day heart failure readmission risk prediction following discharge. Grounded in the [2022 AHA/ACC/HFSA Heart Failure Management guidelines](https://www.ahajournals.org/doi/10.1161/CIR.0000000000001063), this project utilizes an Explainable AI-powered tool for evidence-based decision-making. It integrates Logistic Regression with an LLM-based RAG for clinical summary generation, Guideline-Directed Medical Therapy (GDMT) optimization, and discharge action planning.  
...
All extracted features (including GDMT medications, biomarkers, and vital signs) as well as reports generated by the system's generative AI fully comply with the [American Heart Association's heart failure management guidelines](https://www.ahajournals.org/doi/10.1161/CIR.0000000000001063).
...
<p align="left">
    <i><strong>Fig. Displaying the historical trend of changes in the patient's laboratory values.</strong></i>
  </p>
...
<p align="left">
   <i><strong>Fig. Clinical report and medical recommendations generated by the Large Language Model (LLM) citing reference guidelines.</strong></i>
  </p>
